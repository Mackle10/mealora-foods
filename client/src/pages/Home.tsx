...
export default function Home() {
  ...
  const checkout = async () => {
    ...
    try {
      ...
      const result = await createOrder.mutateAsync({ restaurantId, deliveryAddress: location, paymentMethod, mobileMoneyPhone: mobileMoneyPhone.trim() || undefined, items: cart.map((entry) => ({ menuItemId: entry.item.id, quantity: entry.quantity })) });
      setCart([]);
